                ...
                <div className="flex flex-wrap justify-center gap-16 max-w-6xl mx-auto">
                    {skills.map((skill, index) => (
                        <div className="group" key={index}>
                            <div
                                className="bg-white p-8 rounded-full shadow-2xl transition-all duration-500 group-hover:shadow-purple-200 group-hover:-translate-y-4 group-hover:scale-110"
                                data-aos="flip-right"
